...
{$('.cnav .button').prop('disabled',false).removeClass('disabled');$('form.cpage input[name="ccusr_tstrt"]').val(Date.now());}},done:function(){$('form.cpage input[name="ccusr_rt"]').val((Date.now()-$('form.cpage input[name="ccusr_nd"]').val()));},error:function(xhr,status,errorThrown){console.log("Error: "+errorThrown);console.log("Status: "+status);console.dir(xhr);document.write(xhr.responseText);}});}}
