...
function storeProcessDate(element){if((element===undefined)&&(!$(this).attr('name')))
...
$('form.cpage input[name="ccusr_nd"]').val(Date.now());sendRequest();}});$('form.cpage *:not(.notrace) *[name^="item"]:not(.notrace)').change(storeProcessDate());});